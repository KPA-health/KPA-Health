...
from backend.models.seed_data import SERVICE_MAPPING
...
SERVICE_VALUES = ", ".join(f"'{service}'" for _, service in SERVICE_MAPPING)
...
# Ejemplos few-shot: (pregunta, SQL esperado o 'NULL', explicación, categoría).
# Incluyen casos de rechazo para que el modelo aprenda a clasificar antes de generar SQL.
