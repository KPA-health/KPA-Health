...
MediPulse.RoomService = {
  /** Camas agrupadas por ala/servicio; el arreglo lleva `source` = 'api' | 'mock'. */
  async getAll() {
  ...
  /**
   * Fija el estado manual de una cama (requiere el permiso 'operations').
   * @param {string} bedId Código de la cama.
   * @param {'Ocupada'|'Libre'|'Desinfección'|'Mantenimiento'|'Auto'} status 'Auto' = estado calculado por el HIS.
   */
