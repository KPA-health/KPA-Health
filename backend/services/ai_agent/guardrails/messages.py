...
# Son parte del contrato JSON con la SPA (campo `category` de /ai/query).
CATEGORY_HOSPITAL = "hospital"
CATEGORY_GREETING = "greeting"
CATEGORY_OUT_OF_SCOPE = "out_of_scope"
CATEGORY_LANGUAGE = "unsupported_language"
CATEGORY_PERSONAL_DATA = "personal_data"
CATEGORY_EMPTY = "empty"

# Valores heredados (versión anterior del prompt, en español) aceptados al leer la salida del LLM
LEGACY_CATEGORY_ALIASES = {
    "saludo": CATEGORY_GREETING,
    "fuera_de_alcance": CATEGORY_OUT_OF_SCOPE,
    "idioma_no_soportado": CATEGORY_LANGUAGE,
    "datos_personales": CATEGORY_PERSONAL_DATA,
    "vacia": CATEGORY_EMPTY,
}
